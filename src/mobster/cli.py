...
from mobster.cmd.generate import modelcar, oci_artifact, oci_image, oci_index, product, pko_package
...
def generate_pko_package_parser(subparsers: Any) -> None:
    ...
    parser = subparsers.add_parser(
        "pko_package", help="Generate an SBOM document that describes a pko package"
    )

...
def generated_by_hermeto(annotations: list[Annotation]) -> bool:
    """
    Will determine if the package was generated by hermeto/cachi2

    Args:
        annotations: List of annotations.

    Returns:
        True if the package was generated by hermeto/cachi2, False otherwise.
    """
...
def sanitize_purl(purl: str) -> str | None:
    ...
    Returns:
        The sanitized purl or None if the purl is invalid.
    """
    try:
    ...
    # type and name were validated by PackageURL.from_string, only version needs to be
    # checked
...
def package_matched(
    ...
    """
    Determine if component package is matched to parent package. The packages' purls are
    ...
    Returns:
        True if the package matched based on the criteria above, False otherwise.
    """
    ...
    parent_purl = sanitize_purl(parent_purl)
    component_purl = sanitize_purl(component_purl)
    if not parent_purl or not component_purl:
        return False

    # Parent package can be generated by hermeto or syft, component package should only
    # be generated by syft. So only parent's tool is checked.

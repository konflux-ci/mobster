...
from mobster.oci.cosign import CosignConfig, SupportsFetch, SupportsSign
...
def get_cosign_fetcher(config: CosignConfig) -> SupportsFetch:
    """
...
def get_cosign_signer(config: CosignConfig) -> SupportsSign:
    """

...
def test_case_spdx_with_hermeto_and_additional() -> GenerateOciImageTestCase:
    ...
    return GenerateOciImageTestCase(
        args=GenerateOciImageCommandArgs(
            ...
            metadata_path=Path("tests/data/dockerfiles/somewhat_believable_sample/metadata.yaml"),
        ),
        expected_sbom_path=Path(
...
def test_case_spdx_with_hermeto_and_content_filtering() -> GenerateOciImageTestCase:
    ...
    return GenerateOciImageTestCase(
        args=GenerateOciImageCommandArgs(
            ...
            metadata_path=Path("tests/data/dockerfiles/somewhat_believable_sample/metadata_no_ubi.yaml"),
        ),
        expected_sbom_path=Path(
...
def test_case_spdx_without_hermeto_without_additional() -> GenerateOciImageTestCase:
    ...
    return GenerateOciImageTestCase(
        args=GenerateOciImageCommandArgs(
            ...
            from_hermeto=None,
            metadata_path=Path("tests/data/dockerfiles/somewhat_believable_sample/metadata_no_tssc_or_ubi.yaml"),
        ),
        expected_sbom_path=Path(
...
def test_case_cyclonedx_with_additional() -> GenerateOciImageTestCase:
    ...
    return GenerateOciImageTestCase(
        args=GenerateOciImageCommandArgs(
            metadata_path=Path("tests/data/dockerfiles/somewhat_believable_sample/metadata_no_tssc.yaml"),
            from_syft=[
                Path(

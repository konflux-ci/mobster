...
def run_delete_command(
    ...
    assert result.returncode == 0, f"Delete command failed with stderr: {result.stderr}"
    return result
...
async def test_delete_tpa_file(
    ...
    run_delete_command(tpa_base_url, f"name={temporary_sbom_name}")
...
async def test_delete_tpa_dry_run(
    ...
    run_delete_command(tpa_base_url, f"name={temporary_sbom_name}", dry_run=True)
...
async def test_delete_tpa_multiple(
    ...
    run_delete_command(tpa_base_url, f"name~{test_prefix}")
...
async def test_delete_tpa_empty_query(
    ...
    run_delete_command(tpa_base_url, "")

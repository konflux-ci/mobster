...
def sbom_index_two_images() -> DocumentIndex:
    ...
    The image package "SPDXRef-image-syft-1234" CONTAINS:
        ...
        - "SPDXRef-Package-math-from-syft" (Which is a DEPENDENCY_OF "SPDXRef-Package-syft-from-syft")

    The image package "SPDXRef-image-oras-1234" CONTAINS:
        - "SPDXRef-Package-mergo-from-oras"
        - "SPDXRef-Package-stdlib-from-oras"
        - "SPDXRef-Package-math-from-oras" (Which is a DEPENDENCY_OF "SPDXRef-Package-mergo-from-oras")
    """

    oras_name = "oras"
    oras_repo = f"quay.io/konflux-ci/{oras_name}"
    oras_version = "sha256:aaaa"
    oras_pullspec = f"{oras_repo}@{oras_version}"

    syft_name = "syft"
    syft_repo = f"quay.io/konflux-ci/{syft_name}"
    syft_version = "sha256:bbbb"
    syft_pullspec = f"{syft_repo}@{syft_version}"
